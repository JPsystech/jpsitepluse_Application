...
const String iosSimulatorApiBaseUrl = "http://192.168.1.29:8011";
...
Future<String> _resolveApiBaseUrlInner() async {
  ...
  if (Platform.isAndroid) {
    final okPhysical = await _canConnect(
        ...
        timeout: const Duration(milliseconds: 400));
    if (okPhysical) {
      return "http://192.168.1.29:8011";
    }
    throw ApiConfigException(
        "Set server IP: use http://<PC_IP>:8011 (example: http://192.168.1.29:8011)");
  }
